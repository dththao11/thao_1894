...
{
    public partial class ComponentImportDetail : UserControl
    {
        ...
        public ComponentImportDetail(Panel home, EditLayout layout, string id, ImportDetail importDetail)
        {
            InitializeComponent();
            this._home = home;
            this._layout = layout;
            this._productId = id;
            this._importDetail = importDetail;
            this.LoadData(id);
        }
